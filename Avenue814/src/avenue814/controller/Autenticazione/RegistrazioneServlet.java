...
public class RegistrazioneServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		UserBean user = new UserBean(request.getParameter("name"), request.getParameter("secondname"),
				request.getParameter("password"), request.getParameter("email"), request.getParameter("username"),
				"cliente");
		...
		try {
			if (userModel.isNewUser(user)) {
				...
				RequestDispatcher dispatcher = this.getServletContext()
						.getRequestDispatcher("/PaginaAutenticazione/register.jsp");
