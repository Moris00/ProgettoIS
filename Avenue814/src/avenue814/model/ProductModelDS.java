...
public class ProductModelDS {
	...
	public void toUpdateDisp(ProductBean item, boolean disp) throws SQLException {
		...
		String sql = "UPDATE Prodotti SET Prodotti.disponibilit� = ? WHERE Prodotti.id_prodotti LIKE ?";
	...
	public void aggiungiQuantita(ProductBean item) throws SQLException {
		Connection connection = ds.getConnection();
		String sql = "UPDATE Prodotti SET Prodotti.quantit� = ? WHERE Prodotti.id_prodotti LIKE ?";
	...
	public void doSave(ProductBean product, UserBean user) throws SQLException {
		...
		Connection connection = ds.getConnection();
		String sql = "INSERT INTO Prodotti(nome, prezzo, descrizione, categoria, quantit�, pathImage, sesso, propriet�) VALUES(?,?,?,?,?,?,?,?)";
		PreparedStatement ps = connection.prepareStatement(sql);
